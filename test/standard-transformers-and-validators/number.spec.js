...
test('number: tests min', t => {
  ...
  t.equal(v.validate({a: 2.1}, rule), undefined);
  ...
  t.equal(v.validate({a: 3}, rule), undefined);
  t.equal(v.validate({a: 4}, rule), undefined);
  t.end();
});
...
test('number: tests greaterThan', t => {
  ...
  t.equal(v.validate({a: 2.2}, rule), undefined);
  t.end();
});
...
test('number: tests lessThan', t => {
  ...
  t.equal(v.validate({a: 2}, rule), undefined);
  t.end();
});
